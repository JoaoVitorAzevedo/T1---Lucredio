...
public interface ParserLAVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link ParserLAParser#op_logico_1}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOp_logico_1(ParserLAParser.Op_logico_1Context ctx);
	/**
	 * Visit a parse tree produced by {@link ParserLAParser#op_logico_2}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOp_logico_2(ParserLAParser.Op_logico_2Context ctx);
	/**
