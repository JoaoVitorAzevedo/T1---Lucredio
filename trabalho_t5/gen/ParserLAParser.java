...
public class ParserLAParser extends Parser {
	...
	public static final int
		...
		RULE_parcela_nao_unario = 37, RULE_exp_relacional = 38, RULE_op_relacional = 39, 
		RULE_expressao = 40, RULE_termo_logico = 41, RULE_fator_logico = 42, RULE_parcela_logica = 43, 
		RULE_op_logico_1 = 44, RULE_op_logico_2 = 45, RULE_op1 = 46, RULE_op2 = 47, 
		RULE_op3 = 48, RULE_op_unario = 49;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"parcela_logica", "op_logico_1", "op_logico_2", "op1", "op2", "op3", 
			"op_unario"
		};
	}
	...
	public static class Op_logico_1Context extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserLAVisitor ) return ((ParserLAVisitor<? extends T>)visitor).visitOp_logico_1(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Op_logico_2Context extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserLAVisitor ) return ((ParserLAVisitor<? extends T>)visitor).visitOp_logico_2(this);
			else return visitor.visitChildren(this);
		}
	}
