...
public class ParserLALexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"ESCREVA", "FIM_ALGORITMO", "SE", "ENTAO", "SENAO", "FIM_SE", "CASO", 
			"SEJA", "FIM_CASO", "PARA", "ATE", "FACA", "FIM_PARA", "ENQUANTO", "FIM_ENQUANTO", 
			"REGISTRO", "FIM_REGISTRO", "TIPO", "VAR", "CONSTANTE", "PROCEDIMENTO", 
			"FIM_PROCEDIMENTO", "FUNCAO", "FIM_FUNCAO", "RETORNE", "VERDADEIRO", 
			"FALSO", "E", "OU", "NAO", "ATRIBUICAO", "OP_REL_DIF", "OP_REL_MAIOR_IGUAL", 
			"OP_REL_MENOR_IGUAL", "INTERVALO", "PONTO", "VIRGULA", "DOIS_PONTOS", 
			"PONTO_E_VIRGULA", "SOMA", "SUBTRACAO", "MULTIPLICACAO", "DIVISAO", "ENDERECO", 
			"MODULO", "PONTEIRO", "ABRE_PARENTESES", "FECHA_PARENTESES", "ABRE_COLCHETES", 
			"FECHA_COLCHETES", "OP_REL_IGUAL", "OP_REL_MAIOR", "OP_REL_MENOR", "CADEIA", 
			"NUM_INT", "NUM_REAL", "IDENT", "COMENTARIO", "WS", "COMENTARIO_NAO_FECHADO", 
			"CADEIA_NAO_FECHADA", "SIMBOLO_NAO_IDENTIFICADO"
		};
	}
