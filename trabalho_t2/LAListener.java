...
public interface LAListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link LAParser#parcela_prima}.
	 * @param ctx the parse tree
	 */
	void enterParcela_prima(LAParser.Parcela_primaContext ctx);
	/**
	 * Exit a parse tree produced by {@link LAParser#parcela_prima}.
	 * @param ctx the parse tree
	 */
	void exitParcela_prima(LAParser.Parcela_primaContext ctx);
	/**
